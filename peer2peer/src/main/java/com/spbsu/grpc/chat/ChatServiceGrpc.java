...
public final class ChatServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.spbsu.grpc.chat.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.spbsu.grpc.chat.Chat.ChatMessage,
      com.spbsu.grpc.chat.Chat.ChatMessageFromServer> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = com.spbsu.grpc.chat.Chat.ChatMessage.class,
      responseType = com.spbsu.grpc.chat.Chat.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.spbsu.grpc.chat.Chat.ChatMessage,
      com.spbsu.grpc.chat.Chat.ChatMessageFromServer> getChatMethod() {
    io.grpc.MethodDescriptor<com.spbsu.grpc.chat.Chat.ChatMessage, com.spbsu.grpc.chat.Chat.ChatMessageFromServer> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod = 
              io.grpc.MethodDescriptor.<com.spbsu.grpc.chat.Chat.ChatMessage, com.spbsu.grpc.chat.Chat.ChatMessageFromServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.spbsu.grpc.chat.ChatService", "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.spbsu.grpc.chat.Chat.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.spbsu.grpc.chat.Chat.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.spbsu.grpc.chat.Chat.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.spbsu.grpc.chat.Chat.ChatMessageFromServer> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.spbsu.grpc.chat.Chat.ChatMessage,
                com.spbsu.grpc.chat.Chat.ChatMessageFromServer>(
                  this, METHODID_CHAT)))
          .build();
    }
  }
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.spbsu.grpc.chat.Chat.getDescriptor();
    }
